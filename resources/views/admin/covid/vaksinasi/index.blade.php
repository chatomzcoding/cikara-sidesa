<x-adminlte-layout title="data vaksinasi" menu="vaksinasi">
    <x-slot name="header">
        <x-header judul="Data vaksinasi" active="pengelolaan vaksinasi"></x-header>
    </x-slot>
    <x-slot name="content">
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <form target="_blank" action="{{ url('/cetakdata')}}" method="get">
                    @csrf
                    <input type="hidden" name="s" value="vaksinasi">
