<x-adminlte-layout title="klasifikasi surat" menu="klasifikasisurat">
    <x-slot name="header">
        <x-header judul="data klasifikasi surat" active="daftar klasifikasi surat"></x-header>
    </x-slot>
    <x-slot name="content">
                            ...
                            <tbody class="text-capitalize">
                                ...
                                <tr>
                                        ...
                                        <td class="text-center">
                                            <form id="data-{{ $item->id }}" action="{{url('/klasifikasisurat',$item->id)}}" method="post">
                                                @csrf
                                                @method('delete')
                                                </form>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                      <a class="dropdown-item text-primary" href="{{ url('/klasifikasisurat/'.Crypt::encryptString($item->id))}}"><i class="fas fa-list"></i> Detail Klasifikasi</a>
