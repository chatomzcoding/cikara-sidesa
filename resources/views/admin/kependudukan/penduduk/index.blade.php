<x-adminlte-layout title="data penduduk" menu="penduduk">
    <x-slot name="header">
        <x-header judul="data penduduk" active="daftar penduduk"></x-header>
    </x-slot>
    <x-slot name="content">
        ...
        <div class="modal fade" id="importupdate">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <form action="{{ url('/import/pendudukupdate')}}" method="post" enctype="multipart/form-data">
                    @csrf
