          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="{{ url('/penduduk')}}" class="btn btn-outline-secondary btn-flat btn-sm"><i class="fas fa-angle-left"></i> Kembali ke daftar penduduk</a>
                <a href="{{ url('/penduduk/'.Crypt::encryptString($penduduk->id).'/edit')}}" class="btn btn-outline-success btn-flat btn-sm"><i class="fas fa-pen"></i> Ubah Data Penduduk</a>
                <button onclick="deleteRow( {{ $penduduk->id }} )" class="btn btn-outline-danger btn-flat btn-sm"><i class="fas fa-trash-alt"></i> Hapus Penduduk</button>
                <a href="{{ url('/cetak/penduduk/'.$penduduk->id)}}" target="_blank" class="btn btn-outline-info btn-flat btn-sm float-right"><i class="fas fa-print"></i> CETAK</a>
            </div>
              <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-3">
                                  <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                    <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true"><i class="fas fa-user"></i> Data Utama</a>
                                    <a class="nav-link" id="v-pills-kelahiran-tab" data-toggle="pill" href="#v-pills-kelahiran" role="tab" aria-controls="v-pills-kelahiran" aria-selected="false"><i class="fas fa-id-card-alt"></i> Data Kelahiran</a>
                                    <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false"><i class="fas fa-address-card"></i> Data Kependudukan</a>
                                    <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-users"></i> Data Keluarga</a>
                                    <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false"><i class="fas fa-user-md"></i> Data Kesehatan</a>
                                    <a class="nav-link" id="v-pills-perkawinan-tab" data-toggle="pill" href="#v-pills-perkawinan" role="tab" aria-controls="v-pills-perkawinan" aria-selected="false"><i class="fas fa-heart"></i> Data Perkawinan</a>
                                  </div>
                                </div>
                                <div class="col-9">
