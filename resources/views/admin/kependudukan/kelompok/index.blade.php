<x-adminlte-layout title="data kelompok" menu="kelompok">
    <x-slot name="header">
        <x-header judul="data kelompok" active="pengelolaan kelompok"></x-header>
    </x-slot>
    <x-slot name="content">
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <form target="_blank" action="{{ url('/cetakdata')}}" method="get">
                    @csrf
                    <input type="hidden" name="s" value="kelompok">
