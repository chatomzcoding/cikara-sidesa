          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="#" data-toggle="modal" data-target="#cetakdokumen" class="btn btn-outline-info btn-sm float-right pop-info" title="Cetak Daftar Lapak Penduduk"><i class="fas fa-print"></i> CETAK</a>
              </div>
              <div class="card-body">
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <form target="_blank" action="{{ url('/cetakdata')}}" method="get">
              @csrf
              <input type="hidden" name="s" value="lapak">
