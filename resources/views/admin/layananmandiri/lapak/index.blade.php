          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="{{ url('cetakdata?s=lapak') }}" target="_blank" class="btn btn-outline-info btn-sm float-right pop-info" title="Cetak Daftar Lapak Penduduk"><i class="fas fa-print"></i> CETAK</a>
              </div>
              <div class="card-body">
