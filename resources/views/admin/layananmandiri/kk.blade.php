          ...
          <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-6">
                  <div class="info-box">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-text">Total Kartu Keluarga</span>
                ...
                <div class="col-12 col-sm-6 col-md-6">
                  <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-text">Total Anggota Keluarga</span>
                      <span class="info-box-number">341</span>
                    </div>
                    <!-- /.info-box-content -->
                  </div>
                  <!-- /.info-box -->
                ...
                {{-- <div class="col-12 col-sm-6 col-md-3">
                  <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                      ...
                      <span class="info-box-number">830</span>
                    </div>
                    <!-- /.info-box-content -->
                  </div>
                  <!-- /.info-box -->
                ...
                {{-- <div class="col-12 col-sm-6 col-md-3">
                  <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-text">Penduduk Pindahan</span>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="#" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#tambah"><i class="fas fa-plus"></i> Tambah Kartu Keluarga Baru </a>
