...
@section('title')
    Selamat Datang di Aplikasi SIDESA
@endsection
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        <div class="welcome_thumb">
                            <div class="thumb_1">
                                <img src="{{ asset('/template/docmed/img/about/1.png')}}" alt="">
                            </div>
                            <div class="thumb_2">
                                <img src="{{ asset('/template/docmed/img/about/2.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                                        ...
                                        <div class="row align-items-center">
                                                ...
                                                <div class="col-xl-6 col-md-6">
                                                    <div class="business_thumb">
                                                        <img src="{{ asset('/template/docmed/img/about/business.png')}}" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                </div>
                            ...
                            @for ($i = 0; $i < 5; $i++)
                                <div class="single_expert">
                                    <div class="expert_thumb">
                                        <img src="{{ asset('/template/docmed/img/experts/1.png')}}" alt="">
                                    </div>
